document.addEventListener("DOMContentLoaded", () => {
  const employees = [
    ...
    },
    {
      ...
      salary: 600000,
      description:
        "Хороший программист, который разрабатывает продукты компании",
  ...
  function renderCards(employees) {
    ...
    employees.forEach((employee) => {
      ...
      <p class='salary'>${employee.salary} Tg.</p>
  ...
  function handleEdit(event) {
    ...
    if (employee) {
      const newName = prompt("Введите новое имя сотрудника", employee.name);
      const newPosition = prompt(
        "Введите новую позицию сотрудника",
        employee.position
      );
      ...
      const newDescription = prompt(
        "Введите новое описание сотрудника",
